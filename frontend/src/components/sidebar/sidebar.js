...
import {  faChartPie, faFileAlt, faSignOutAlt, faTimes, faFileExcel, faBook } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <NavItem title="QA/QC Upload" link={Routes.QaQc.path} icon={faFileExcel} />
              <NavItem title="Demo Analytic" link={Routes.Overview.path} icon={faChartPie} />
              <NavItem title="Document Classify" link={Routes.DocumentClassify.path} icon={faBook} />
